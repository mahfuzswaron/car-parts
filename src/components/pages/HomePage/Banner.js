    ...
    return (
        <div className='relative flex items-center'>
            ...
            <div className='z-1 absolute ml-5 lg:pl-20 text-secondary'>
                <h1 className='lg:text-7xl text-lg  font-semibold uppercase'>Welcome to <br></br><span className='lg:text-8xl text-xl text-primary lg:-ml-1'> PARTS UNIVERSE</span> </h1>
